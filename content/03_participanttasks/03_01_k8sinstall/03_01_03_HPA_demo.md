...
5. Monitor Application Scaling down on master node
...
6. Delete client deployment to stop sending client traffic

    ```bash
    kubectl delete deployment infinite-calls
    ```
    
7. Monitor Application Scaling down on master node
